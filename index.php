...
<body>
  <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
      ...
      <div class="menu">
        <div class="opcion">
          ...
          if (isset($_SESSION['username'])) {
            ...
            echo '<a href="./php/logout.php" class="logout-option">Cerrar sesión</a>';
            echo '</div>';
          } else {
            echo '<div class="inicarSesion">';
            echo '<a href="login.php"><h2>Iniciar Sesión</h2></a>';
            echo '</div>';
            echo '<div class="registrarse">';
            echo '<a href="register.php"><h2>Registrarse</h2></a>';
            echo '</div>';
          }
          ?>
        </div>
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <div class="contenido">
          ...
          <div class="Descripcion">
            <p>Las emblemáticas fuentes han dejado de fluir, y un extraño misterio amenaza su agua. Tu misión es clara:
              desentrañar las causas de esta interrupción. Atrévete a sumergirte en esta historia y descubre los
              secretos que podrían restaurar el equilibrio perdido.</p>
          </div>
          <div class="botones"><a href="./PanelJoc.html">
              <h1>EXPLORA</h1>
            </a></div>
        </div>
      ...
      <div class="carousel-item">
        <div class="contenido">
          <div class="TituloInicio">
            <h1>¡Explora un mundo magnifico!</h1>
          </div>
          <div class="Descripcion">
            <p>El agua ha perdido su pureza, y el reto es claro: atravesar escenarios llenos de obstáculos para
              devolverle su claridad. A medida que avances, los desafíos se intensificarán. ¿Serás capaz de resolver el
              enigma y dar el primer paso hacia la restauración?</p>
          </div>
          <div class="botones">
      ...
      <div class="carousel-item">
        <div class="contenido">
          ...
          <div class="Descripcion">
            <p>En tu camino encontrarás máquinas y sistemas fallidos que necesitan ajustes. Cada mecanismo roto esconde
              pistas vitales y complejos rompecabezas que deberás resolver para acercarte a la solución final. ¿Podrás
              hacer que las aguas fluyan otra vez?</p>
          </div>
          <div class="botones">
      ...
      <div class="carousel-item">
        <div class="contenido">
          <div class="TituloInicio">
            <h1>¡Atrévete a descubrir más!</h1>
          </div>
          <div class="Descripcion">
            <p>El destino de las tres fuentes está en tus manos. Con todos los desafíos superados, tu ingenio y
              perseverancia te llevarán al logro definitivo. Devuelve el agua limpia y purificada a cada fuente y
              celebra el triunfo de haber completado la misión. ¿Estás listo para restaurar el equilibrio?</p>
          </div>
          <div class="botones"><a href="./PanelJoc.html">
              <h1>DIVIERTE</h1>
            </a></div>
  ...
  <footer>
    <div class="FooterDerechos">
      <p>Copyright © 2024 Cientifiks. Todos los derechos reservados.</p>
    </div>
    <div class="Redes">
      <h1 id="scrollToTop">Cientifiks</h1>
    </div>
  </footer>
